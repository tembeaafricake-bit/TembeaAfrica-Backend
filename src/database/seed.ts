...
async function seed() {
  ...
  const sarahId = users.insertedIds[4]
  ...
  // ─── GUIDES ────────────────────────────────────────────────────────────────
  // Create additional guide users first
  const guideUsers = await db.collection('users').insertMany([
    { firstName: 'Charles', lastName: 'Mwangi', email: 'charles@tembeaafrica.com', password: hashedPassword, role: 'guide', isVerified: true, createdAt: new Date() },
    { firstName: 'Fatuma', lastName: 'Ngugi', email: 'fatuma@tembeaafrica.com', password: hashedPassword, role: 'guide', isVerified: true, createdAt: new Date() },
    { firstName: 'Daniel', lastName: 'Oloo', email: 'daniel@tembeaafrica.com', password: hashedPassword, role: 'guide', isVerified: true, createdAt: new Date() },
    { firstName: 'Grace', lastName: 'Mutua', email: 'grace@tembeaafrica.com', password: hashedPassword, role: 'guide', isVerified: true, createdAt: new Date() },
  ])
  ...
  await db.collection('guides').insertMany([
    ...
    { user: guideUsers.insertedIds[0], bio: 'KPAP-certified mountain guide with 15 years summiting Kilimanjaro and Mount Kenya. Expert in wilderness first aid and high-altitude acclimatization.', languages: ['English', 'Swahili'], certifications: ['KPAP Level 3', 'Wilderness First Responder', 'Mountain Guide'], specializations: ['Kilimanjaro', 'Mount Kenya', 'Technical climbing'], experience: 15, hourlyRate: 20, dailyRate: 120, rating: 4.9, reviewCount: 72, category: 'mountain', verified: true, status: 'active', isDeleted: false, createdAt: new Date() },
    { user: guideUsers.insertedIds[1], bio: 'Wildlife photography guide specialising in golden hour shoots. 6 years of professional experience across Kenya and Tanzania safaris.', languages: ['English', 'Swahili', 'German'], certifications: ['Professional Photographer', 'Safari Guide Certificate'], specializations: ['Wildlife photography', 'Sunrise shoots', 'Portrait sessions'], experience: 6, hourlyRate: 25, dailyRate: 95, rating: 4.8, reviewCount: 54, category: 'photography', verified: false, status: 'active', isDeleted: false, createdAt: new Date() },
    { user: guideUsers.insertedIds[2], bio: 'Nairobi city guide with intimate knowledge of hidden gems, street art, nightlife and local food culture. 5 years experience.', languages: ['English', 'Swahili', 'Luo'], certifications: ['City Guide Certificate', 'Food Tour Expert'], specializations: ['Nairobi food tours', 'Street art', 'Local markets'], experience: 5, hourlyRate: 10, dailyRate: 45, rating: 4.7, reviewCount: 88, category: 'city', verified: true, status: 'active', isDeleted: false, createdAt: new Date() },
    { user: guideUsers.insertedIds[3], bio: 'Safari guide passionate about Amboseli\'s elephant families and night drives. 9 years of experience with emphasis on conservation.', languages: ['English', 'Swahili', 'Kikuyu'], certifications: ['KWS Level 2', 'Conservation Guide'], specializations: ['Amboseli elephants', 'Night drives', 'Bush walks'], experience: 9, hourlyRate: 14, dailyRate: 75, rating: 4.8, reviewCount: 63, category: 'safari', verified: true, status: 'active', isDeleted: false, createdAt: new Date() },
  ])
