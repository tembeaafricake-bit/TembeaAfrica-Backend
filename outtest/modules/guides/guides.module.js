...
exports.GuidesModule = GuidesModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: guide_schema_1.Guide.name, schema: guide_schema_1.GuideSchema }])],
        controllers: [guides_controller_1.GuidesController],
        providers: [guides_service_1.GuidesService],
        exports: [guides_service_1.GuidesService, mongoose_1.MongooseModule],
    })
], GuidesModule);
